...
@section('title', 'Search Documents - Document Management System')
                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="text-muted mb-0">Find the documents you need with our advanced search</p>
                        </div>
                        <div class="col-md-4 text-md-end">
                            @if($query)
                                <span class="badge bg-primary fs-6">{{ $documents->total() }} results found</span>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('frontend.search') }}" method="GET" class="row g-3">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <input type="text"
                                       ...
                                       name="q"
                                       value="{{ $query }}"
                                       placeholder="Search documents, authors, or descriptions...">
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2">
                            <select class="form-select form-control-custom" name="sort">
                                ...
                                <option value="evaluations_count" {{ request('sort') == 'evaluations_count' ? 'selected' : '' }}>Reviews</option>
                            </select>
                        </div>
                        <div class="col-md-1">
        ...
        <div class="col-12">
            <div class="card card-custom">
                <div class="card-body text-center p-5">
                    ...
                    <p class="text-muted">Enter keywords above to find documents in our library.</p>
                </div>
            </div>
        </div>
    </div>
